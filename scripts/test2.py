...
DEFAULT_INPUT = Path("test/rag_retrieval_test_data_1.csv")
DEFAULT_OUTPUT = Path("test/rag_retrieval_eval_results_1.csv")
DEFAULT_SUMMARY = Path("test/rag_retrieval_eval_summary_1.json")
DEFAULT_TOP_K = 5
